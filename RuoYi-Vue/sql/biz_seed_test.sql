...
-- 正常情况下不需要手动执行此脚本。
-- 如需手动导入：
--    mysql -u root -p ry_vue < biz_seed_test.sql
--
-- 测试账号：test001 / 123456
-- =====================================================
...
INSERT INTO biz_insurance_company (
    ...
    -- bcrypt($2a$10$) encode of "123456" — 与 DataInitializer 使用相同逻辑
    '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2',
    'a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6',
    'x1y2z3w4v5u6t7s8r9q0p1o2n3m4l5k6j7i8h7g6f5e4d3c2b1a0',
    100000.00, 30,
    '0', '张三', '13800138000', '测试用保险公司',
    'admin', sysdate()
);
